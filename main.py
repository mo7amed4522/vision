...
agePhoto = "age_deploy.prototxt"
ageModel = "age_net.caffemodel"

genderPhoto = "gender_deploy.prototxt"
genderModel = "gender_net.caffemodel"

faceNet = cv2.dnn.readNet(faceModel, facePhoto)
ageNet = cv2.dnn.readNet(ageModel, agePhoto)
...
while True:
    ...
    frame, bboxs = makeFaceBox(faceNet, frame)
    for bbox in bboxs:
